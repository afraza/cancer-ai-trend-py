...
SELECT 
    row_index, 
    clean_title || ' ' || clean_abstract || ' ' || clean_authoe_keywords || ' ' || clean_index_keywords AS title_abstract_keywords
FROM {table_name}
"""
...
# Save
save_npz("article_ai_terms_occurrence.npz", article_ai_terms_occurrence)
